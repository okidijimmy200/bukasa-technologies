...
const Form = () => {
	return (
		<section className='bg-white mb-10 rounded-2xl '>
			...
			<form className='m-4 flex flex-col items-center justify-center gap-4'>
				<div className="">
					<input type="text" placeholder='Name' className='outline-gray-300 bg-gray-100 p-3 rounded-lg lg:w-[800px] w-[350px] lg:text-base text-sm' />
				</div>
				<div className="">
					<input type="tel" placeholder='Phone' className='outline-gray-300 bg-gray-100 p-3 rounded-lg lg:w-[800px] w-[350px] lg:text-base text-sm' />
				</div>
				<div className="">
					<input type="email" placeholder='Email' className='outline-gray-300 bg-gray-100 p-3 rounded-lg lg:w-[800px] w-[350px] lg:text-base text-sm' />
				</div>
				<div className="">
					<input type="text" placeholder='Purpose for training' className='outline-gray-300 bg-gray-100 p-3 rounded-lg lg:w-[800px] w-[350px] lg:text-base text-sm' />
				</div>
				...
				<div className="">
					<input type="text" placeholder='Transaction ID' className='outline-gray-300 bg-gray-100 p-3 rounded-lg lg:w-[800px] w-[350px] lg:text-base text-sm' />
				</div>
